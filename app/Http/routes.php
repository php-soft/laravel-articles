...
Route::group(['middleware'=>'auth'], function() { // use middleware jwt.auth if use JSON Web Token
    ...
    Route::post('articles/{id}', '\PhpSoft\Articles\Controllers\ArticleController@moveToTrash');
    Route::post('articles/{id}', '\PhpSoft\Articles\Controllers\ArticleController@restoreFromTrash');
});
